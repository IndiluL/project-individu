...
public class form_pelanggan extends javax.swing.JFrame {
    ...
    private void klikTable(){
        tableplgn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                int baris = tableplgn.getSelectedRow();
                if (baris >= 0) {
                    txtid.setText(tableplgn.getValueAt(baris, 0).toString());
                    txtnama.setText(tableplgn.getValueAt(baris, 1).toString());
                    String jk = tableplgn.getValueAt(baris, 2).toString();
                    if (jk.equals("Laki-Laki")) {
                        plaki.setSelected(true);
                    } else {
                        pperempuan.setSelected(true);
                    }
                    txttelp.setText(tableplgn.getValueAt(baris, 3).toString());
                    txtalamat.setText(tableplgn.getValueAt(baris, 4).toString());
                }
            }
        });
    }
    ...
    protected void datatable(){
        Object[] Baris = {"ID Pelanggan", "Nama", "Jenis Kelamin", "No. Telepon", "Alamat"};
            ...
            try{
                String sql = "SELECT * FROM pelanggan WHERE id_pelanggan LIKE '%" + cariitem + "%' " + "OR nama_pelanggan LIKE '%" + cariitem + "%' " + "OR jenis_kelamin LIKE '%" + cariitem + "%' " + "OR no_telp LIKE '%" + cariitem + "%' " + "OR alamat LIKE '%" + cariitem + "%' " + "ORDER BY id_pelanggan ASC";
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnbatal, javax.swing.GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtnama, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        try{
            String sql = "UPDATE pelanggan set nama_pelanggan=?, jenis_kelamin=?, no_telp=?, alamat=? WHERE id_pelanggan=?";
            PreparedStatement stat = koneksi.prepareStatement(sql);
