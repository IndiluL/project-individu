...
public class PopupPelanggan extends javax.swing.JFrame {
    ...
    public form_nota pelanggan = null;
    ...
    private void tablepelangganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablepelangganMouseClicked
        ...
        pelanggan.jenis = tablepelanggan.getValueAt(tableplgn, 2).toString();
        pelanggan.telp = tablepelanggan.getValueAt(tableplgn, 3).toString();
        pelanggan.alamat = tablepelanggan.getValueAt(tableplgn, 4).toString();
